...
function AuctionatorListExportFrameMixin:OnShow()
	...
	Auctionator.EventBus:RegisterSource(self, "lists export dialog 1"):Fire(self,
		Auctionator.ShoppingLists.Events.DialogOpened):UnregisterSource(self)
end
...
function AuctionatorListExportFrameMixin:AddToPool()
	...
	table.insert(self.checkBoxPool,
		CreateFrame("FRAME", "ExportListCheckbox" .. newIndex, self.ScrollFrame.ListListingFrame,
