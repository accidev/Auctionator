...
local function InitializeFromDetails(details)
	...
	local frame = CreateFrame("BUTTON", frameName, AuctionHouseFrame, "AuctionatorTabButtonTemplate")
...
function AuctionatorTabContainerMixin:OnLoad()
	...
	-- order
	table.sort(Auctionator.Tabs.State.knownTabs, function(left, right)
