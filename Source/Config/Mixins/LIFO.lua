...
function AuctionatorConfigLIFOFrameMixin:Save()
	...
	Auctionator.Config.Set(Auctionator.Config.Options.LIFO_AUCTION_SALES_PREFERENCE,
		self.CommoditySalesPreference:GetValue())
	Auctionator.Config.Set(Auctionator.Config.Options.LIFO_UNDERCUT_PERCENTAGE,
