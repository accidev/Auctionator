...
function AuctionatorConfigNotLIFOFrameMixin:Save()
	...
	Auctionator.Config.Set(Auctionator.Config.Options.NOT_LIFO_AUCTION_SALES_PREFERENCE,
		self.ItemSalesPreference:GetValue())
	Auctionator.Config.Set(Auctionator.Config.Options.NOT_LIFO_UNDERCUT_PERCENTAGE,
		Auctionator.Utilities.ValidatePercentage(self.ItemUndercutPercentage:GetNumber()))
	Auctionator.Config.Set(Auctionator.Config.Options.NOT_LIFO_UNDERCUT_STATIC_VALUE,
		tonumber(self.ItemUndercutValue:GetAmount()))
