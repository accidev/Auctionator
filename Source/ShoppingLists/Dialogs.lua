local function InitializeCreateDialog()
	StaticPopupDialogs[Auctionator.Constants.DialogNames.CreateShoppingList] = {
		...
		OnAccept = function(self)
			Auctionator.EventBus:Fire(self, Auctionator.ShoppingLists.Events.CreateDialogOnAccept, self.editBox:GetText())
		end,
		EditBoxOnEnterPressed = function(self)
			Auctionator.EventBus:Fire(self:GetParent(), Auctionator.ShoppingLists.Events.CreateDialogOnAccept, self:GetText())
			self:GetParent():Hide()
		end,
		timeout = 0,
		exclusive = 1,
...
local function InitializeDeleteDialog()
	StaticPopupDialogs[Auctionator.Constants.DialogNames.DeleteShoppingList] = {
		...
		OnAccept = function(self)
			Auctionator.EventBus:Fire(self, Auctionator.ShoppingLists.Events.DeleteDialogOnAccept)
		end
	};
end
...
local function InitializeRenameDialog()
	StaticPopupDialogs[Auctionator.Constants.DialogNames.RenameShoppingList] = {
		...
		OnAccept = function(self)
			Auctionator.EventBus:Fire(self, Auctionator.ShoppingLists.Events.RenameDialogOnAccept, self.editBox:GetText())
		end,
		EditBoxOnEnterPressed = function(self)
			Auctionator.EventBus:Fire(self:GetParent(), Auctionator.ShoppingLists.Events.RenameDialogOnAccept, self:GetText())
			self:GetParent():Hide()
		end,
		timeout = 0,
		exclusive = 1,
