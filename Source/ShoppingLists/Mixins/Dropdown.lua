...
function AuctionatorShoppingListDropdownMixin:SetUpEvents()
	...
	Auctionator.EventBus:Register(self,
		{Auctionator.ShoppingLists.Events.ListCreated, Auctionator.ShoppingLists.Events.ListDeleted,
   Auctionator.ShoppingLists.Events.ListRenamed})
	FrameUtil.RegisterFrameForCustomEvents(self, {"AUCTION_HOUSE_CLOSED"})
end
...
function AuctionatorShoppingListDropdownMixin:ReceiveEvent(eventName, eventData)
	if eventName == Auctionator.ShoppingLists.Events.ListDeleted or eventName ==
		Auctionator.ShoppingLists.Events.ListCreated then
