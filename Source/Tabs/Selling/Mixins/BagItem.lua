...
function AuctionatorBagItemMixin:SetItemInfo(info)
	...
	if info ~= nil then
		...
		self.IconBorder:SetVertexColor(ITEM_QUALITY_COLORS[self.itemInfo.quality].r,
			ITEM_QUALITY_COLORS[self.itemInfo.quality].g, ITEM_QUALITY_COLORS[self.itemInfo.quality].b, 1)
