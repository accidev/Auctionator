...
function AuctionatorConfirmDropDownMixin:OnLoad()
	...
	Auctionator.EventBus:Register(self, {Auctionator.Selling.Events.ConfirmCallback, Auctionator.AH.Events.Ready})
end
...
function AuctionatorConfirmDropDownMixin:Initialize()
	...
	confirmInfo.text = AUCTIONATOR_L_CONFIRM .. " " ..
		                   Auctionator.Utilities.CreateMoneyString(self.data.price * self.data.quantity)
