function Auctionator.AH.Initialize()
	...
	Auctionator.AH.Internals.throttling = CreateFrame("FRAME", "AuctionatorAHThrottlingFrame", AuctionHouseFrame,
		"AuctionatorAHThrottlingFrameTemplate")

	Auctionator.AH.Internals.itemKeyLoader = CreateFrame("FRAME", "AuctionatorAHItemKeyLoaderFrame", AuctionHouseFrame,
