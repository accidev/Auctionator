...
Auctionator.Enchant.DE_TABLE[Auctionator.Enchant.DE_KEY(WEAPON, RARE)] =
	Auctionator.Enchant.DE_TABLE[Auctionator.Enchant.DE_KEY(ARMOR, RARE)];
...
Auctionator.Enchant.DE_TABLE[Auctionator.Enchant.DE_KEY(WEAPON, EPIC)] = CopyDeep(
	Auctionator.Enchant.DE_TABLE[Auctionator.Enchant.DE_KEY(ARMOR, EPIC)]); -- copy it this time because of differences

deInsert(Auctionator.Enchant.DE_TABLE[Auctionator.Enchant.DE_KEY(ARMOR, EPIC)],
	{61, 80, 50, 1, NEXUS_CRYSTAL, 50, 2, NEXUS_CRYSTAL});
deInsert(Auctionator.Enchant.DE_TABLE[Auctionator.Enchant.DE_KEY(WEAPON, EPIC)],
