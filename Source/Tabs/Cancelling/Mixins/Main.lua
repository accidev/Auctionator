...
function AuctionatorCancellingFrameMixin:OnLoad()
	...
	Auctionator.EventBus:Register(self,
		{Auctionator.Cancelling.Events.RequestCancel, Auctionator.Cancelling.Events.RequestAllCancel,
...
function AuctionatorCancellingFrameMixin:ReceiveEvent(eventName, eventData, ...)
	...
	elseif eventName == Auctionator.Cancelling.Events.TotalUpdated then
		self.Total:SetText(AUCTIONATOR_L_TOTAL_ON_SALE:format(Auctionator.Utilities.CreateMoneyString(eventData)))
	end
end
