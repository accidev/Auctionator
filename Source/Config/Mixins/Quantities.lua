...
function AuctionatorConfigQuantitiesFrameMixin:OnLoad()
	...
	self.Quantities = {"WeaponQuantity", "ArmorQuantity", "ContainerQuantity", "ConsumableQuantity", "GlyphQuantity",
                    "TradeGoodsQuantity", "AmmoQuantity", "QuiverQuantity", "RecipesQuantity", "GemQuantity",
                    "QuestQuantity", "MiscQuantity"}
end
