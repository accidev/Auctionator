...
function AuctionatorFullScanStatusMixin:OnLoad()
	Auctionator.EventBus:Register(self,
		{Auctionator.IncrementalScan.Events.ScanStart, Auctionator.IncrementalScan.Events.ScanProgress,
   Auctionator.IncrementalScan.Events.ScanComplete, Auctionator.IncrementalScan.Events.ScanFailed,
   Auctionator.FullScan.Events.ScanStart, Auctionator.FullScan.Events.ScanProgress,
   Auctionator.FullScan.Events.ScanComplete, Auctionator.FullScan.Events.ScanFailed})
end
