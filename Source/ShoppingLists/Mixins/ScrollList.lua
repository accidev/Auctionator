...
function AuctionatorScrollListMixin:OnLoad()
	...
	self.searchProvider:InitSearch(function(results)
		self:EndSearch(results)
	end, function(current, total, results)
		...
		self.InsetFrame.ResultsText:SetText(Auctionator.Locales.Apply("LIST_SEARCH_STATUS", current, total,
...
function AuctionatorScrollListMixin:SetUpEvents()
	...
	Auctionator.EventBus:Register(self,
		{Auctionator.ShoppingLists.Events.ListSelected, Auctionator.ShoppingLists.Events.ListDeleted,
   Auctionator.ShoppingLists.Events.ListItemSelected, Auctionator.ShoppingLists.Events.ListItemAdded,
   Auctionator.ShoppingLists.Events.ListItemReplaced, Auctionator.ShoppingLists.Events.ListSearchRequested,
   Auctionator.ShoppingLists.Events.ListItemDeleted, Auctionator.ShoppingLists.Events.ListOrderChanged})
end
