...
local function ModifyBuyBackButton()
	...
	hooksecurefunc(AuctionHouseCommoditiesBackButtonMixin, "OnClick", function()
...
function AuctionatorShoppingListResultsRowMixin:OnClick(button, ...)
	...
	elseif button == "RightButton" then
		Auctionator.EventBus:RegisterSource(self, "ShoppingListResultsRowMixin"):Fire(self, Auctionator.ShoppingLists.Events
			.ShowHistoricalPrices, self.rowData):UnregisterSource(self)
	else
